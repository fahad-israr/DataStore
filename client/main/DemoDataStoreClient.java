...
public class DemoDataStoreClient {
	public static void main(String[] args) {
		...
		jsonObject.put("firstName", "Fahad");
		jsonObject.put("lastName", "Israr");
		jsonObject.put("address", "Lucknow");
		System.out
				.println("=============================================================");
		System.out
				.println("========================CREATE ==============================");
		...
		DataStore myDataStore = new DataStore(
				"C:\\Users\\Fahad\\Documents\\DataStore");
		 ...
		 * DataStore("C:\\Users\\Fahad\\Documents\\DataStore");
